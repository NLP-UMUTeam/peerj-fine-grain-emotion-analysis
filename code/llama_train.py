...
def train_model(model, train_dataset, eval_dataset, save_path):
    ...
    trainer.save_model(f'{save_path}/llamaClassification')
...
def main(args): 
    ...
    model = AutoModelForSequenceClassification.from_pretrained(model_path, num_labels=len(label2id), load_in_8bit=True)
